...
const translations = {
  en: {
    ...
    nav_beginner: "SMARTSTART",
    nav_learner: "MOST POPULAR",
    nav_explorer: "MAXIMUMSAVER",
    ...
    plan_desc: "More Lessons,Lower Price Per Lesson!.",
    ...
    hero_explorer_savings_badge: "BEST SAVINGS PLAN",
    hero_explorer_title_1: "Maximum Learning,",
    hero_explorer_title_2: "Maximum Savings!",
    hero_explorer_package: "30 lessons package • Only $5 per lesson",
    hero_explorer_desc: "The most complete learning journey for serious progress and long-term success.",
    hero_explorer_feat1_title: "Best Value",
    hero_explorer_feat1_desc: "Lowest price per lesson",
    hero_explorer_feat2_title: "Stronger Progress",
    hero_explorer_feat2_desc: "More practice, better results",
    hero_explorer_feat3_title: "Build Confidence",
    hero_explorer_feat3_desc: "Gain skills and speak with ease",
    hero_explorer_feat4_title: "Flexible & Safe",
    hero_explorer_feat4_desc: "Upgrade or cancel anytime",
    hero_explorer_cta: "Choose MaximumSaver - 30 Lessons",
    hero_explorer_cta_sub: "Upgrade or switch anytime",
    hero_explorer_floating_badge: "The most committed learners choose this plan!",
    ...
    hero_learner_popular_badge: "MOST POPULAR PLAN",
    hero_learner_title_1: "Best Value for",
    hero_learner_title_2: "Steady Progress",
    hero_learner_package: "20 lessons package • Only $6 per lesson",
    hero_learner_desc: "The perfect balance of value, commitment, and results.",
    hero_learner_feat1_title: "Better Value",
    hero_learner_feat1_desc: "Pay less per lesson",
    hero_learner_feat2_title: "Steady Progress",
    hero_learner_feat2_desc: "Build skills step by step",
    hero_learner_feat3_title: "Boost Confidence",
    hero_learner_feat3_desc: "See improvement within weeks",
    hero_learner_cta: "Choose Best Value - 20 Lessons",
    hero_learner_cta_sub: "Upgrade or switch anytime",
    hero_learner_floating_badge: "Most students choose this plan!",
    ...
    hero_beginner_perfect_badge: "PERFECT TO GET STARTED",
    hero_beginner_title_1: "The Smart Start",
    hero_beginner_title_2: "to Your Child's",
    hero_beginner_title_3: "English Journey",
    hero_beginner_package: "10 lessons package • Only $7 per lesson",
    hero_beginner_desc: "A fun and engaging way for young learners to build strong foundations and fall in love with learning.",
    hero_beginner_feat1_title: "Easy to Start",
    hero_beginner_feat1_desc: "Start small, no pressure",
    hero_beginner_feat2_title: "Build Confidence",
    hero_beginner_feat2_desc: "Learn, practice and grow",
    hero_beginner_feat3_title: "Flexible & Safe",
    hero_beginner_feat3_desc: "Upgrade anytime, cancel anytime",
    hero_beginner_cta: "Start SmartStart - 10 Lessons",
    hero_beginner_cta_sub: "Upgrade or switch anytime",
    hero_beginner_floating_badge: "Great for first-time learners and beginners!",
  ...
  ar: {
    ...
    nav_beginner: "البداية الذكية",
    nav_learner: "الأكثر شيوعاً",
    nav_explorer: "أقصى توفير",
    ...
    plan_desc: "المزيد من الدروس، سعر أقل للدرس الواحد!",
    ...
    hero_explorer_savings_badge: "خطة التوفير الأفضل",
    hero_explorer_title_1: "أقصى قدر من التعلم،",
    hero_explorer_title_2: "أقصى قدر من التوفير!",
    hero_explorer_package: "حزمة 30 درس • فقط 5 دولار لكل درس",
    hero_explorer_desc: "الرحلة التعليمية الأكثر اكتمالاً من أجل تقدم جاد ونجاح طويل الأمد.",
    hero_explorer_feat1_title: "أفضل قيمة",
    hero_explorer_feat1_desc: "أقل سعر لكل درس",
    hero_explorer_feat2_title: "تقدم أقوى",
    hero_explorer_feat2_desc: "مزيد من الممارسة، نتائج أفضل",
    hero_explorer_feat3_title: "تعزيز الثقة",
    hero_explorer_feat3_desc: "اكتساب المهارات والتحدث بسهولة",
    hero_explorer_feat4_title: "مرن وآمن",
    hero_explorer_feat4_desc: "ترقية أو إلغاء في أي وقت",
    hero_explorer_cta: "اختر أقصى توفير - 30 درس",
    hero_explorer_cta_sub: "الترقية أو التغيير في أي وقت",
    hero_explorer_floating_badge: "المتعلمون الأكثر التزاماً يختارون هذه الخطة!",
    ...
    hero_learner_popular_badge: "الخطة الأكثر شيوعاً",
    hero_learner_title_1: "أفضل قيمة من أجل",
    hero_learner_title_2: "تقدم ثابت",
    hero_learner_package: "حزمة 20 درس • فقط 6 دولار لكل درس",
    hero_learner_desc: "التوازن المثالي بين القيمة والالتزام والنتائج.",
    hero_learner_feat1_title: "قيمة أفضل",
    hero_learner_feat1_desc: "ادفع أقل لكل درس",
    hero_learner_feat2_title: "تقدم ثابت",
    hero_learner_feat2_desc: "بناء المهارات خطوة بخطوة",
    hero_learner_feat3_title: "تعزيز الثقة",
    hero_learner_feat3_desc: "شاهد التحسن في غضون أسابيع",
    hero_learner_cta: "اختر أفضل قيمة - 20 درس",
    hero_learner_cta_sub: "الترقية أو التغيير في أي وقت",
    hero_learner_floating_badge: "معظم الطلاب يختارون هذه الخطة!",
    ...
    hero_beginner_perfect_badge: "مثالي للبدء",
    hero_beginner_title_1: "البداية الذكية",
    hero_beginner_title_2: "لرحلة طفلك",
    hero_beginner_title_3: "في اللغة الإنجليزية",
    hero_beginner_package: "حزمة 10 دروس • فقط 7 دولار لكل درس",
    hero_beginner_desc: "طريقة ممتعة وجذابة للمتعلمين الصغار لبناء أسس قوية والوقوع في حب التعلم.",
    hero_beginner_feat1_title: "سهل البدء",
    hero_beginner_feat1_desc: "ابدأ صغيراً، بدون ضغوط",
    hero_beginner_feat2_title: "بناء الثقة",
    hero_beginner_feat2_desc: "تعلم، تدرب وانمو",
    hero_beginner_feat3_title: "مرن وآمن",
    hero_beginner_feat3_desc: "ترقية في أي وقت، إلغاء في أي وقت",
    hero_beginner_cta: "ابدأ البداية الذكية - 10 دروس",
    hero_beginner_cta_sub: "الترقية أو التغيير في أي وقت",
    hero_beginner_floating_badge: "رائع للمتعلمين لأول مرة والمبتدئين!",
